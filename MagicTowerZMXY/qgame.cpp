...
//story,scence,talk,fight，sound,Script!!!
void QGame::handleGameKey(int key)
{
    ...
    case GS_INIT:
        ...
        // if (story->OnKeyDown(key) == false)
        // {
        //     gameState = GS_WALK;//游戏状态切换到GS_WALK。
        //     QSound::play(SOUND_BG_FILE);//游戏状态切换到GS_WALK。
        // }
        break;
    case GS_WALK:
        ...
        break;
    case GS_TALK:
        //调用QTalk.OnKeyDown(key)处理对话中的按键
        // if (QTalk.OnKeyDown(key) == false)
        // {
        //     //如果返回false，表示对话结束，状态切换回GS_WALK，并执行脚本。
        //     gameState = GS_WALK;
        //     recurScript();
        // }
        break;
...
//         if (story->OnTimer(event->timerId()) == false)
//         {
//             /*如果返回false，初始化阶段结束：
//             游戏状态切换到GS_WALK。
//             播放背景音乐SOUND_BG_FILE*/
...
// //     DWORD Param1 = script.GetScriptInfo().Param1;
// //     DWORD Param2 = script.GetScriptInfo().Param2;
// //     DWORD Param3 = script.GetScriptInfo().Param3;
