...
constexpr auto qt_meta_stringdata_CLASSTileButtonENDCLASS = QtMocHelpers::stringData(
    "TileButton",
    "updateDefaltTile",
    ""
);
...
void TileButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateDefaltTile(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TileButton::updateDefaltTile; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TileButton::updateDefaltTile()
{
